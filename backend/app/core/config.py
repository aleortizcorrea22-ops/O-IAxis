...
class Settings(BaseSettings):
    ...
    # CORS — separar por coma, o "*" para permitir todo en producción
    ALLOWED_ORIGINS: str = "http://localhost:3001,http://127.0.0.1:3001,http://localhost:3000,http://127.0.0.1:3000"
